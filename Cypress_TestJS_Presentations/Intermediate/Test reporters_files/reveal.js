...
(function( root, factory ) {
    ...
    keyboardShortcuts['?'] = 'Keyboard Shortcuts Toggle';
		keyboardShortcuts['F'] = 'Fullscreen Mode';
		keyboardShortcuts['ESC, O']  = 'Slides Overview Mode';
		keyboardShortcuts['B'] = 'Pause / Resume Toggle';
    keyboardShortcuts['M'] = 'Menu Table-of-Contents Toggle';
	...
	function showHelp() {
		...
		if( config.help ) {
			...
			var html = '<p class="title">GitPitch Keyboard Shortcuts</p>';
